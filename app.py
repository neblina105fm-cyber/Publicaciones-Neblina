...
<head>
    ...
    <title>Sorteo Neblina 105.5 FM - Multiplataforma iOS Style</title>
    ...
    <style>
        ...
        * {
        ...
        /* CONTENEDOR DE SIMULACIÓN DE DISPOSITIVO */
        .viewport-frame {
            width: 100%;
            display: flex;
            ...
            <section id="stage-1" class="stage active">
                <div class="setup-grid">
                    <div class="panel-box">
                        ...
                        <div class="footer-info">Total: <span id="count-display">0</span> / 150</div>
                    </div>
                ...
                <div class="game-layout">
                    ...
                    <div class="wheel-container">
                        ...
                        <div style="margin-top: 15px; display: flex; gap: 8px; width: 100%;">
                            ...
                            <button class="ios-btn" style="background: rgba(0,0,0,0.05); color: var(--text-primary);" onclick="resetApp()">
                                🔄
                            </button>
                        </div>
                    </div>
